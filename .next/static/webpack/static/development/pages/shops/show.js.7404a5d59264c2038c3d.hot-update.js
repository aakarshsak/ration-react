      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function componentDidMount$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              console.log('name');
              _this$getInit = this.getInit(), data = _this$getInit.data, status = _this$getInit.status;
...
//# sourceMappingURL=show.js.7404a5d59264c2038c3d.hot-update.js.map