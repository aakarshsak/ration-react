...
var RegisterForm = /*#__PURE__*/function (_Component) {
  ...
  function RegisterForm() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "onSubmit", function _callee(event) {
      var _this$state, password, confirm_pass, email, pin, house, area, district, state, phone, first, middle, last, aadhar, country, data, headers, _ref, text, status;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _this$state = _this.state, password = _this$state.password, confirm_pass = _this$state.confirm_pass, email = _this$state.email, pin = _this$state.pin, house = _this$state.house, area = _this$state.area, district = _this$state.district, state = _this$state.state, phone = _this$state.phone, first = _this$state.first, middle = _this$state.middle, last = _this$state.last, aadhar = _this$state.aadhar, country = _this$state.country;
              data = {
                name: {
                  first: first,
                  middle: middle,
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(RegisterForm, [{
    ...
    value: function render() {
      ...
      return __jsx(_components_layout_js__WEBPACK_IMPORTED_MODULE_10__["default"], null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Grid"], {
        ...
        widths: "equal"
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Form"].Field, null, __jsx("label", null, "Country"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Select"], {
        placeholder: "Country",
        options: Object(_localmodules_location_location_dropdown__WEBPACK_IMPORTED_MODULE_13__["getCountryList"])(),
      ...
      })), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Form"].Field, null, __jsx("label", null, "State"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Select"], {
        placeholder: "State",
        options: Object(_localmodules_location_location_dropdown__WEBPACK_IMPORTED_MODULE_13__["getStateList"])(Object(_localmodules_location_location_dropdown__WEBPACK_IMPORTED_MODULE_13__["matchCountry"])('India').id.toString()),
      ...
      })), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Form"].Field, null, __jsx("label", null, "District"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Select"], {
        placeholder: "District",
        options: Object(_localmodules_location_location_dropdown__WEBPACK_IMPORTED_MODULE_13__["getCityList"])(Object(_localmodules_location_location_dropdown__WEBPACK_IMPORTED_MODULE_13__["matchState"])(this.state.state, Object(_localmodules_location_location_dropdown__WEBPACK_IMPORTED_MODULE_13__["matchCountry"])('India').id.toString()).id),
      ...
      }))), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Form"].Group, null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Form"].Field, null, __jsx("label", null, "Area"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Select"], {
        placeholder: "Area",
        options: Object(_localmodules_location_location_dropdown__WEBPACK_IMPORTED_MODULE_13__["getBlocksList"])(),
      ...
      })), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Form"].Field, null, __jsx("label", null, "Pin"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Input"], {
        type: "number",
        placeholder: "Pin",
...
//# sourceMappingURL=register.js.b0843ea3588a64a63a05.hot-update.js.map