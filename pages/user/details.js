...
export default class UserDetails extends Component {
    ...
    static async getInitialProps(props) {
        ...
        return { data, headerToken, loggedIn };
    }
            ...
            <Grid>
                ...
                <Grid.Column width={12}>
                    <Card fluid>
                        ...
                        <Card.Content style = {{marginLeft:'30px'}}>
                        ...
                        <Card.Content style = {{marginLeft:'30px'}}>
                            ...
                            <Segment attached>
                                {this.props.data.address.house + ', ' + this.props.data.address.area + ', ' + this.props.data.address.district + ', ' + 
                        ...
                        <Card.Content style = {{marginLeft:'30px'}}>
                            ...
                            <Segment attached>
                                {this.props.data.address.area.toUpperCase()}
                            </Segment>
                        </Card.Content>
                    </Card>
                </Grid.Column>
